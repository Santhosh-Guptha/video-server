...
class CameraStream(Base):
    ...
    pixel_format: Mapped[str | None] = mapped_column(String(32), nullable=True)
    gop: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    browser_compatible: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    transcoding_required: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    archive_type: Mapped[str | None] = mapped_column(String(32), default="continuous", nullable=True)
    preferred_live_codec: Mapped[str | None] = mapped_column(String(16), default="H264", nullable=True)
    preferred_playback_codec: Mapped[str | None] = mapped_column(String(16), default="H264", nullable=True)
    last_probe: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    probe_version: Mapped[str | None] = mapped_column(String(16), default="1.0", nullable=True)
