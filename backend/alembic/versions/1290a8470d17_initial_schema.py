...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('profile_type', sa.Enum('MAIN', 'SUB', 'MOBILE', name='profile_type_enum', create_type=False), nullable=False),
        ...
        sa.Column('status', sa.Enum('REGISTERED', 'CONNECTING', 'ONLINE', 'DEGRADED', 'RECONNECTING', 'OFFLINE', 'ERROR', name='stream_state_enum', create_type=False), server_default='REGISTERED', nullable=False),
