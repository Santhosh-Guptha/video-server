...
# Installs dependencies, sets up virtualenv, configs, MediaMTX, and starts systemd services.
...
# Copy mediamtx config from project
...
if [ -f "$BACKEND_DIR/requirements.txt" ]; then
    ...
    log_error "requirements.txt not found at $BACKEND_DIR/requirements.txt!"
    exit 1
fi
...
log_success "Backend and MediaMTX setup complete!"
...
log_success "Video Platform Backend is fully deployed!"
